 ...
 * `dreamsmith build <dir> [-out <output.bin] [-id <32 character hexadecimal string>]` - builds a new cartridge image based on `Audio_XX.wav`, `Audio_XX.led` and `Effect_XX.wav` files from the specified directory
